  ...
  return (
    <div className='flex flex-col justify-around items-center text-white w-screen h-screen m-0 relative'>
        ...
        <div className='flex flex-row justify-around -mt-8 w-[80%] h-[20%]'>
            <div className=''>
                <button className='button p-2'><p className='button-txt'>Image Analyzer</p></button>
            </div>
            <div className=''>
                <button className='button p-2'><p className='button-txt'>Video Analyzer</p></button>
            </div>
            <div className=''>
                <button className='button p-2'><p className='button-txt'>Text Analyzer</p></button>
            </div>
        </div>
    </div>
  )
